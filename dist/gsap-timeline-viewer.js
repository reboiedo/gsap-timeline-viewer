...
class q extends HTMLElement {
  ...
  cycleSpeed() {
    ...
    this.speedIndex = (this.speedIndex + 1) % S.length;
    const t = S[this.speedIndex];
  ...
  checkPlayrangeConstraint() {
    if (!this.timeline || this.playrangeStart === 0 && this.playrangeEnd === 1) return;
